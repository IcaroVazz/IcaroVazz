...
<p align="center">
  ...
  <a href="#superpoderes">⚡ Superpoderes</a> •
  <a href="#arsenal">🛠️ Arsenal</a> •
  <a href="#numeros">📊 Números que falam</a> •
  <a href="#projetos">🧪 Projetos</a> •
  <a href="#dominio">🧠 Domínio técnico</a> •
  <a href="#foco">🎯 Foco atual</a> •
...
<table align="center">
  <tr>
    <td align="center" width="33%">
      ...
      <sub>Engenharia de prompts, RAG com busca semântica, agentes autônomos com tool calling e MCP — LLMs virando produto de verdade.</sub>
    </td>
    <td align="center" width="33%">
      <h3>🔒 Segurança de ponta a ponta</h3>
      <sub>RBAC, autenticação robusta, sessões com auto-logout e rastreabilidade total de cada ação no sistema.</sub>
    </td>
    <td align="center" width="33%">
      <h3>🏛️ Arquitetura que escala</h3>
      <sub>Clean architecture, código limpo, monorepos e serverless — sistemas que continuam mantíveis depois de anos.</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <h3>🤖 Automação inteligente</h3>
      <sub>Agentes que leem, interpretam, classificam e geram documentos — reduzindo trabalho manual e erros humanos.</sub>
    </td>
    <td align="center" width="33%">
      <h3>📊 Decisão baseada em dados</h3>
      <sub>ETL, dashboards, relatórios automatizados (PDF, PPT, Excel) e BI institucional para apoiar a gestão.</sub>
    </td>
    <td align="center" width="33%">
      <h3>⚡ Entrega contínua</h3>
      <sub>CI/CD com GitHub Actions, Docker, deploy serverless frequente e sem medo — de branch para produção com segurança.</sub>
    </td>
  </tr>
</table>
...
| Tecnologia | Uso |
| --- | --- |
| React 19 / Next.js (App Router) | Aplicações web modernas, SSR/SSG, rotas de API |
| Tailwind CSS / shadcn/ui | Design system, UI institucional, componentes acessíveis |
...
| Tecnologia | Uso |
| --- | --- |
| Node.js / Express | APIs REST, middlewares, rate limiting, validação |
| Next.js API Routes / Serverless | Netlify Functions, Firebase Functions, Edge Functions |
| Firebase Auth + JWT + OAuth2 | Autenticação, sessões com auto-logout, RBAC |
...
| Capacidade | Detalhe |
| --- | --- |
| Prompt engineering | Few-shot, chain-of-thought, sistemas de prompt versionáveis |
| RAG | Embeddings, busca semântica, vetores (pgvector, Redis) |
| Agentes autônomos | Tool calling, loops de raciocínio, MCP |
| Fine-tuning | Modelos ajustados a domínios institucionais e documentos |
...
| Ferramenta | Uso |
| --- | --- |
| GitHub Actions | CI/CD, cron jobs, automação de pipelines |
...
<p align="center">
  ...
  <img height="180em" src="https://streak-stats.demolab.com?user=IcaroVazz&theme=tokyonight&hide_border=true" alt="Streak" />
...
| Categoria | Detalhe |
| --- | --- |
| Arquitetura | Aplicações web, monorepos, serverless, padrões que resistem ao tempo |
| LLMs & IA | RAG, agentes autônomos, prompt engineering, embeddings, tool calling, MCP |
| Segurança | Autenticação, RBAC, controle de permissões, sessões com expiração |
| Frontend | UI institucional, design systems, componentes headless e acessíveis |
| Backend | APIs REST, Next.js API routes, serverless functions, webhooks |
| Banco de Dados | PostgreSQL, Firestore, Supabase, MongoDB, Redis, vetores (pgvector) |
| Infra | Cloud (Firebase, Netlify, Vercel), CI/CD GitHub Actions, Docker |
...
- ♻️ Refatorando o **AcompanhaTec** de React.js para Next.js.
...
<p align="center">
  <a href="mailto:icarovaz952@gmail.com" target="_blank">
    <img src="https://img.shields.io/badge/icarovaz952%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="E-mail" />
  </a>
  <a href="https://www.linkedin.com/in/icarovazz/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="https://github.com/IcaroVazz" target="_blank">
